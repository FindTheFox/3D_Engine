...
/*   Updated: 2020/03/05 17:29:48 by saneveu          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void                    clip_edges(t_dyntab *to_raster, t_triangle t, int point)
{
    ...
    {
        to_add = clip_triangle((t_vec){0,W_H - 1,0,0}, (t_vec){0,-1.0f,0,0}, t, clip);
    ...
    {
        to_add = clip_triangle((t_vec){W_W - 1,0,0,0}, (t_vec){-1.0f,0,0,0}, t, clip);
